...
export const data ={
    ...
    {
      "id": 1,
      "titulo": "Descuento del 20% en tratamientos faciales",
      "descripcion": "Aprovecha un 20% de descuento en todos nuestros tratamientos faciales durante este mes.",
      "enlace": "https://example.com/ofertas/tratamientos-faciales-descuento"
    },
    {
      "id": 2,
      "titulo": "Nueva línea de productos para el cuidado del cabello",
      "descripcion": "Descubre nuestra nueva línea de productos capilares, perfectos para nutrir y revitalizar tu cabello.",
      "enlace": "https://example.com/noticias/productos-capilares-nuevos"
    },
    {
      "id": 3,
      "titulo": "Oferta especial en masajes relajantes",
      "descripcion": "Reserva un masaje relajante y obtén un 50% de descuento en tu próxima sesión.",
      "enlace": "https://example.com/ofertas/masajes-relajantes"
    },
    {
      "id": 4,
      "titulo": "Concurso: Gana un día de spa gratis",
      "descripcion": "Participa en nuestro concurso y podrás ganar un día completo de spa sin costo.",
      "enlace": "https://example.com/noticias/concurso-dia-de-spa"
    },
    {
      "id": 5,
      "titulo": "Nuevos horarios extendidos para tratamientos",
      "descripcion": "Ahora abrimos hasta más tarde para que disfrutes de nuestros servicios cuando más te convenga.",
      "enlace": "https://example.com/noticias/horarios-extendidos"
    },
    {
      "id": 6,
      "titulo": "Lanzamiento de tratamientos anti-edad",
      "descripcion": "Presentamos nuestra nueva línea de tratamientos anti-edad, diseñados para rejuvenecer tu piel.",
      "enlace": "https://example.com/noticias/tratamientos-anti-edad"
    },
    {
      "id": 7,
      "titulo": "Descuento en depilación láser",
      "descripcion": "Obtén un 30% de descuento en todas las sesiones de depilación láser por tiempo limitado.",
      "enlace": "https://example.com/ofertas/depilacion-laser"
    },
    {
      "id": 8,
      "titulo": "Promoción en manicura y pedicura",
      "descripcion": "Manicura y pedicura a precio especial por este mes. ¡No te lo pierdas!",
      "enlace": "https://example.com/ofertas/manicura-pedicura"
    },
    {
      "id": 9,
      "titulo": "Nueva ubicación: más cerca de ti",
      "descripcion": "Estamos emocionados de anunciar la apertura de nuestra nueva sucursal. ¡Visítanos!",
      "enlace": "https://example.com/noticias/nueva-ubicacion"
    },
    {
      "id": 10,
      "titulo": "Ofertas exclusivas para miembros",
      "descripcion": "Conviértete en miembro y accede a ofertas exclusivas y descuentos especiales.",
      "enlace": "https://example.com/ofertas/membresia"
    }
  ]
  }